					...
					<div class="media-body p-4 d-flex flex-column flex-md-row mx-auto mx-lg-0">
						<div class="primary-info">
							...
							<ul class="list-unstyled">
								...
								<li><a href="#"><i class="fas fa-mobile-alt fa-fw mr-2" data-fa-transform="grow-6"></i>(77)
										98103-1817</a></li>
							</ul>
						</div>
						<!--//primary-info-->
						<div class="secondary-info ml-md-auto mt-2">
							<ul class="resume-social list-unstyled">
								...
								<li class="mb-3"><a href="#"><span class="fa-container text-center mr-2"><i
												class="fab fa-facebook fa-fw"></i></span>angelo.patricio.94</a></li>
								<li class="mb-3"><a href="#"><span class="fa-container text-center mr-2"><i
												class="fab fa-instagram fa-fw"></i></span>angelopatriciosilveira</a></li>
							</ul>
						</div>
						<!--//secondary-info-->

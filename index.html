...
<head>
	<title>CV / Ângelo Patricio Silveira Soares </title>
...
<body>
		...
		<div class="resume-wrapper-inner mx-auto text-left bg-white shadow-lg">
				...
				<div class="media flex-column flex-md-row">
					...
					<div class="media-body p-4 d-flex flex-column flex-md-row mx-auto mx-lg-0">
						<div class="primary-info">
							<h1 class="name mt-0 mb-1 text-white text-uppercase text-uppercase">Ângelo Patricio Silveira Soares</h1>
							<div class="title mb-3">Desenvolvedor Frontend</div>
							<ul class="list-unstyled">
								<li class="mb-2"><a href="#"><i class="far fa-envelope fa-fw mr-2"
											data-fa-transform="grow-3"></i>angelo.silveira09@gmail.com</a></li>
								<li><a href="https://api.whatsapp.com/send?phone=5577981031817" target="_blank"><i
											class="fas fa-mobile-alt fa-fw mr-2" data-fa-transform="grow-6"></i>(77)
										98103-1817</a></li>
							</ul>
						</div>
						<!--//primary-info-->
						<div class="secondary-info ml-md-auto mt-2">
							<ul class="resume-social list-unstyled">
								<li class="mb-3"><a href="https://github.com/angelosilveira" target="_blank"><span
			...
			<div class="resume-body p-5">
				<section class="resume-section summary-section mb-5">
					<h2 class="resume-section-title text-uppercase font-weight-bold pb-3 mb-3">Resumo</h2>
					<div class="resume-section-content">
						<p class="mb-0">Apaixonado por programação, tecnologia,
							games e esportes.
							Submeto meu currículo na expectativa de obter uma
							oportunidade, onde possa aprimorar meus
							conhecimentos e seguir com meu
							desenvolvimento pessoal, assumindo mais
							esse desafio. A empresa sempre contará com
							meu empenho, dedicação, força de vontade e
							comprometimento.</p>
					</div>
				</section>
				<!--//summary-section-->
				<div class="row">
					<div class="col-lg-9">
						<section class="resume-section experience-section mb-5">
							<h2 class="resume-section-title text-uppercase font-weight-bold pb-3 mb-3">EXPERIÊNCIA DE TRABALHO</h2>
							<div class="resume-section-content">
								<div class="resume-timeline position-relative" style="display: flex; flex-direction:column-reverse;">
									<article class="resume-timeline-item position-relative pb-5">

										<div class="resume-timeline-item-header mb-2">
											<div class="d-flex flex-column flex-md-row">
												<h3 class="resume-position-title font-weight-bold mb-1">Desenvolvedor Frontend</h3>
												<div class="resume-company-name ml-auto">JetBrackets</div>
											</div>
											<!--//row-->
											<div class="resume-position-time">01/2016 - 12/2016</div>
										</div>
										<!--//resume-timeline-item-header-->
										<div class="resume-timeline-item-desc">
											<p>
												Participei de projetos voltado para o público americano onde fui responsavel pelo
												desenvolvimento
												de aplicações privadas onde era responsavel pelo frontend e backend usando Meteor.js e
												WordPress.
											</p>
									...
									<article class="resume-timeline-item position-relative pb-5">
										...
										<div class="resume-timeline-item-header mb-2">
											...
											<!--//row-->
											<div class="resume-position-time">01/2017 - 07/2018</div>
										</div>
										<!--//resume-timeline-item-header-->
										<div class="resume-timeline-item-desc">
									...
									<article class="resume-timeline-item position-relative pb-5">
										...
										<!--//resume-timeline-item-header-->
										<div class="resume-timeline-item-desc">
											<p>Empresa voltada para o dropshipping onde usamos a API da shopify para poder criar apps e ajudar
												os clientes há alavancar suas vendas, a empresa também desenvolveu alguns trabalhos públicos
												como:</p>
											<ul>
												<li><a href="https://www.papovip.com.br/" target="_blank">https://www.papovip.com.br</a></li>
												<li><a href="https://www.agendadoprodutor.com/"
														target="_blank">https://www.agendadoprodutor.com</a></li>
												</li>
											</ul>
											...
											<ul class="list-inline">
												...
												<li class="list-inline-item"><span class="badge badge-primary badge-pill">Redux Saga</span></li>
									...
									<article class="resume-timeline-item position-relative pb-5">
										...
										<div class="resume-timeline-item-header mb-2">
											<div class="d-flex flex-column flex-md-row">
												<h3 class="resume-position-title font-weight-bold mb-1">Desenvolvedor Frontend
													<small class="text-muted font-weight-normal">(Freelancer)</small>
												</h3>
										...
										<div class="resume-timeline-item-desc">
											<p>
												Empresa voltada para o mundo esportivo, juntos conseguimos desenvolver algumas aplicações
												internas e vários trabalhos para
											...
											<ul>
												...
												<li><a href="https://www.londrinabank.com.br"
														target="_blank">https://www.londrinabank.com.br</a></li>
											</ul>
											<h4 class="resume-timeline-item-desc-heading font-weight-bold">Tecnologias usada:</h4>
											<ul class="list-inline">
												<li class="list-inline-item"><span class="badge badge-primary badge-pill">HTML5</span></li>
					...
					<div class="col-lg-3">
							...
							<div class="resume-section-content">
									...
									<ul class="list-unstyled mb-4">
										...
										<li class="mb-2">
											...
											<div class="progress resume-progress">
												<div class="progress-bar theme-progress-bar-dark" role="progressbar" style="width: 90%"
										...
										<li class="mb-2">
											<div class="resume-skill-name">Design Responsivo</div>
											<div class="progress resume-progress">
												<div class="progress-bar theme-progress-bar-dark" role="progressbar" style="width: 80%"
													aria-valuenow="25" aria-valuemin="0" aria-valuemax="100"></div>
											</div>
										...
										<li class="mb-2">
											<div class="resume-skill-name">Cypress</div>
											<div class="progress resume-progress">
												<div class="progress-bar theme-progress-bar-dark" role="progressbar" style="width: 50%"
													aria-valuenow="25" aria-valuemin="0" aria-valuemax="100"></div>
											</div>
								...
								<div class="resume-skill-item">
									...
									<ul class="list-unstyled">
										<li class="mb-2">
											...
											<div class="progress resume-progress">
												<div class="progress-bar theme-progress-bar-dark" role="progressbar" style="width: 70%"
													aria-valuenow="25" aria-valuemin="0" aria-valuemax="100"></div>
											</div>
										</li>
										...
										<li class="mb-2">
											<div class="resume-skill-name">Shopify/Liquid</div>
											<div class="progress resume-progress">
												<div class="progress-bar theme-progress-bar-dark" role="progressbar" style="width: 80%"
													aria-valuenow="25" aria-valuemin="0" aria-valuemax="100"></div>
											</div>
								...
								<div class="resume-skill-item">
									...
									<ul class="list-inline">
										...
										<li class="list-inline-item"><span class="badge badge-light">Jquery</span></li>
										<li class="list-inline-item"><span class="badge badge-light">Redux</span></li>
										<li class="list-inline-item"><span class="badge badge-light">Redux Saga</span></li>
										<li class="list-inline-item"><span class="badge badge-light">BEM</span></li>
										...
										<li class="list-inline-item"><span class="badge badge-light">Material UI</span></li>
						...
						<section class="resume-section education-section mb-5">
							<h2 class="resume-section-title text-uppercase font-weight-bold pb-3 mb-3">Educacional</h2>
							<div class="resume-section-content">
								<ul class="list-unstyled">
									<li class="mb-2">
										<div class="resume-degree font-weight-bold">Técnico em informatica</div>
										<div class="resume-degree-org">Instituto Federal da Bahia</div>
										<div class="resume-degree-time">2014 - 2016</div>
									</li>
									<li class="mb-2">
										<div class="resume-degree font-weight-bold">Analise e desenvolvimento de sistemas</div>
										<div class="resume-degree-org">Unopar</div>
										<div class="resume-degree-time">2016 - 2017 (Trancado)</div>
									</li>
						...
						<section class="resume-section language-section mb-5">
							<h2 class="resume-section-title text-uppercase font-weight-bold pb-3 mb-3">Linguagem</h2>
							<div class="resume-section-content">
								<ul class="list-unstyled resume-lang-list">
									<li class="mb-2"><span class="resume-lang-name font-weight-bold">Português</span> <small
											class="text-muted font-weight-normal">(Nativa)</small></li>
								</ul>
							</div>
						</section>
						<!--//language-section-->
						<section class="resume-section interests-section mb-5">
							<h2 class="resume-section-title text-uppercase font-weight-bold pb-3 mb-3">Interesses</h2>
							<div class="resume-section-content">
								<ul class="list-unstyled">
									<li class="mb-1">Network</li>
									<li class="mb-1">Conhecimento</li>
									<li class="mb-1">Amizades</li>
									<li class="mb-1">Finanças</li>
									<li class="mb-1">Resultados</li>
								</ul>
							</div>
						</section>
						<!--//interests-section-->
	...
	<footer class="footer text-center pt-2 pb-5 d-none">
